...
def tagtotext():
    ...
    path= 'C:/Users/201-24/nyj/RAM_model/recognize-anything/capture_images/'
    scenes= os.listdir(path)

    caption=[]
    for cap in scenes:
        # image_path = os.path.join(path, cap)
        # print(image_path)
        print(cap)
        ...
        parser.add_argument('--image',
                            ...
                            default= os.path.join(path, cap))
        parser.add_argument('--pretrained',
                            metavar='DIR',
                            help='path to pretrained model',
                            default='C:/Users/201-24/nyj/RAM_model/recognize-anything/pretrained/tag2text_swin_14m.pth')
