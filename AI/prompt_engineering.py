...
# 피드백
feedback=['Recast', 'Explicit correction', 'Elicitation',
          'Metalinguistic feedback', 'Clarification requests', 'Repetition']
...
system= f"""
            ...
            While leading the conversation, Keep in mind that your most important task is to give feedbacks to the student about the grammar mistake that he or she makes. 
              ...
              Among the six feedback strategies, use the {selected_feedback} strategy that the student chooses.
              ...
              <<Examplars>>
                ...
                'Elicitation': 'Eliciting the correct form from the learner without providing It. 
                    S: She got catched by.. T: She got [pause] (elicitation) S:caught.',
                'Metalinguistic feedback': 'Providing metalinguistic information about the error  
                    S: I have saw this car. T: Please be careful when you say "have." 
                    (ISO ko)자, 여기서부터는 한국어로 설명할게요. 이전에 과거 "경험"을 이야기 할 때 "현재 완료" 시제를 쓴다고 설명했을 거에요. 
                    현재 완료를 쓸 때에는  have 동사와 꼭 분사, 즉 pp를 씁니다. 그래서 "seen"이 되어야 해요!
                    Have를 쓸 때는 (metalinguistic feedback)',
            ...
            -------
              Next, you adjust the level of your remarks considering the {selected_level} level selected by the student. 
              ...
              The selected level is as follows: 
                    ...
                    Personal information, daily routines, my typical day at home, at work, talking about experiences, my house, my flat, my country, daily routines, 
                    my family, my likes and dislikes, my school, my past experiences with past simple and present perfect, my favourite food, verb phrases, word formations, places and buildings
...
#조건문 If the user input is Korean, the original language is also Korean. If not, it is English. 
#If the original language is Korean, the user input is translated to English, which is shown as "English"
...
while True:
    ...
    if original_language == "Korean":
        translated_user_input = translate_text(user_input, "English")
        messages.append({"role": "user", "content": translated_user_input})
